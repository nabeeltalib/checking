...
const Trending = () => {
  ...
  return (
    <div>
      <h1 className="font-extralight text-2xl text-left w-full mt-8" style={{ fontFamily: "'Permanent Marker', cursive" }}>Trending Lists</h1>
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mb-4 max-w-4xl mx-aut mt-5">
        {user.id
