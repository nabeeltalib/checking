        ...
        columns={[
          {
            ...
            render: (item: any) => (
              <div className="flex items-center">
                ...
                <Link to={item.path} className="text-primary-500 hover:underline">{item.name}</Link>
              </div>
            ),
          },
        ...
        columns={[
          {
            ...
            render: (item: any) => (
              <div className="flex items-center">
                <Link to={item.path} className="text-primary-500 hover:underline">{item.title}</Link>
              </div>
            ),
          },
